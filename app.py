...
RUBRICS = {
    ...
    "Thailand (AMLO)": ROOT / "rubrics" / "amlostr.md",
...
GUIDANCE = {
    ...
    "Thailand (AMLO)": ROOT / "guidance" / "th-amlo.md",
...
JURISDICTION_AUTHORITIES = {
    ...
    "Thailand (AMLO)": [
        {"abbr": "AMLO", "name": "Anti-Money Laundering Office"},
        {"abbr": "BOT", "name": "Bank of Thailand"},
        {"abbr": "SEC", "name": "Securities and Exchange Commission"},
        {"abbr": "OIC", "name": "Office of Insurance Commission"},
    ],
    "Japan (JAFIC)": [
...
ENTITY_CATEGORIES = {
    ...
    "Thailand (AMLO)": [
        "— Select —",
        "Commercial bank — BOT-supervised (e.g. BBL, KBank, SCB, KTB, BAY)",
        "Foreign-bank branch — BOT-supervised",
        "Finance company — BOT-supervised",
        "Specialised financial institution (SFI — e.g. GSB, BAAC, EXIM Thailand)",
        "Securities company — SEC-supervised",
        "Derivatives intermediary — SEC-supervised",
        "Mutual fund / asset management company — SEC-supervised",
        "Custodian — SEC-supervised",
        "Digital asset operator (exchange / broker / dealer / fund manager / custodian) — SEC-registered",
        "Life insurance company — OIC-supervised",
        "Non-life insurance company — OIC-supervised",
        "Money changer — BOT-licensed",
        "Money remittance / e-payment service provider — BOT-licensed",
        "Pawnbroker — local-authority licensed (DNFBP)",
        "Personal loan / car-title-loan operator (DNFBP)",
        "Real estate agent / developer (DNFBP — Ministerial Regulation No. 11)",
        "Dealer in precious metals / stones / jewellery (DNFBP)",
        "Antique dealer (DNFBP)",
        "Lawyer / notarial-services practitioner (DNFBP — captured activities)",
        "Accountant (DNFBP — captured activities)",
    ],
    "Japan (JAFIC)": [
        "— Select —",
