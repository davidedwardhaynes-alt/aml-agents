...
RSS_FEEDS: dict[str, list[tuple[str, str, str]]] = {
    ...
    "Singapore (STRO)": [
        ...
        ("CPIB news", "https://www.cpib.gov.sg/press-room/rss", "Enforcement"),
        ("SGX regulation", "https://www.sgx.com/regulation/rss", "Regulatory"),
        ("IMDA news", "https://www.imda.gov.sg/news-and-events/rss", "Regulatory"),
    ],
    "Hong Kong (JFIU)": [
        ...
        ("MPFA news", "https://www.mpfa.org.hk/en/news-press-releases/rss", "Regulatory"),
        ("PCPD news", "https://www.pcpd.org.hk/english/news_events/rss.xml", "Regulatory"),
        ("FSTB news", "https://www.fstb.gov.hk/en/rss/news.xml", "Regulatory"),
    ],
    "Malaysia (FIED)": [
        ...
        ("MACC / SPRM news", "https://www.sprm.gov.my/index.php?page_id=20&rss=1", "Enforcement"),
        ("PDP Malaysia news", "https://www.pdp.gov.my/jpdpv2/feed", "Regulatory"),
    ],
    "Australia (AUSTRAC SMR)": [
        ...
        ("ACMA news", "https://www.acma.gov.au/about-us/news-room/rss", "Regulatory"),
        ("AFSA news", "https://www.afsa.gov.au/about-us/news-and-events/rss", "Regulatory"),
        ("AFCA news", "https://www.afca.org.au/news/rss", "Regulatory"),
        ("OAIC news", "https://www.oaic.gov.au/news/rss", "Regulatory"),
    ],
    # Additional APAC jurisdictions — surface in "All jurisdictions" filter
    "Other APAC": [
        ("RBI India press", "https://rbi.org.in/Scripts/Rss.aspx?Cat=PressRelease", "Regulatory"),
        ("RBI India notifications", "https://rbi.org.in/Scripts/Rss.aspx?Cat=Notification", "Regulatory"),
        ("SEBI India news", "https://www.sebi.gov.in/sebirss.xml", "Regulatory"),
        ("BOT Thailand news", "https://www.bot.or.th/en/news-and-media/rss.html", "Regulatory"),
        ("SEC Thailand news", "https://www.sec.or.th/EN/Pages/News/RSS.aspx", "Regulatory"),
        ("BSP Philippines media", "https://www.bsp.gov.ph/MediaCorner/Pages/news.aspx?feed=rss", "Regulatory"),
        ("Bank Indonesia news", "https://www.bi.go.id/en/publikasi/ruang-media/news/rss", "Regulatory"),
        ("OJK Indonesia news", "https://www.ojk.go.id/en/berita-dan-kegiatan/siaran-pers/rss.aspx", "Regulatory"),
        ("FSA Japan news", "https://www.fsa.go.jp/en/news/index.rss", "Regulatory"),
        ("Bank of Japan press", "https://www.boj.or.jp/en/announcements/release_2025/rss.xml", "Regulatory"),
        ("FSC Korea news", "https://www.fsc.go.kr/eng/no010102/rss", "Regulatory"),
        ("BoK Korea news", "https://www.bok.or.kr/eng/main/contents.do?menuNo=400060&rss=true", "Regulatory"),
        ("FSC Taiwan news", "https://www.fsc.gov.tw/en/rss.xml", "Regulatory"),
        ("CSRC China news", "http://www.csrc.gov.cn/csrc_en/c102030/common_list.shtml?channelId=24009dee9f1c4b22a1d22f55f7c7a8df", "Regulatory"),
        ("PBoC China press", "http://www.pbc.gov.cn/en/3688112/3688172/index.rss", "Regulatory"),
        ("AMLC Philippines", "https://www.amlc.gov.ph/feed", "Enforcement"),
        ("FMU Pakistan news", "https://www.fmu.gov.pk/feed", "Regulatory"),
        ("RBNZ news", "https://www.rbnz.govt.nz/feeds/news", "Regulatory"),
        ("FMA New Zealand", "https://www.fma.govt.nz/feed/news/", "Regulatory"),
        ("APG (Asia/Pacific Group on ML)", "https://www.apgml.org/news/index.aspx?type=rss", "Regulatory"),
    ],
