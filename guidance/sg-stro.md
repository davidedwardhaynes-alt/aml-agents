...
- Payment institutions, e-money institutions, money-changing and remittance businesses
- MAS-regulated digital payment token (DPT) service providers
- Capital markets firms — CMS licensees, fund managers, REIT managers
- Insurers, brokers, financial advisers
- DNFBPs — lawyers, accountants, corporate service providers, real estate agents, precious stones and metals dealers (PSMD)

### Threshold for filing
"Knows or has **reasonable grounds to suspect**" that any property:
- represents the proceeds of, or
- was used in connection with, or
- is intended to be used in connection with

…drug trafficking or other serious offences (CDSA s.39) or terrorism financing (TSOFA s.8 / s.10).

> **Reasonable grounds** is an objective standard, not certainty. The bar is suspicion, not proof.

### Timing
- File "as soon as is reasonably practicable" after suspicion is formed (CDSA s.39(1))
- Industry best practice: within **5 business days** of escalation to MLRO
...
3. Description of suspicious activity — transactions, dates, amounts, channels, counterparties
4. Indicia of suspicion (red flags observed)
5. Reasonable grounds for suspicion (the narrative)
6. Action taken — account status, internal escalation
7. Supporting documents

### Tipping-off (CDSA s.48)
**Strict prohibition.** Do NOT disclose to the customer (or any third party) that:
- An STR has been or is being filed
- An investigation is being conducted
- Law enforcement has been notified

The customer may be told that an account is restricted or closed for "compliance reasons" only. No specifics.

**Penalty:** up to **S$250,000** fine and/or **3 years** imprisonment.

### Record retention
**Minimum 5 years** from filing date — STR itself, supporting documents, internal escalations, customer communications, decision rationale.

### Penalties (non-compliance)
- Failure to file: up to **S$250,000** fine, 3 years imprisonment
